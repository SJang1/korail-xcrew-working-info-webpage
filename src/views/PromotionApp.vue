...
<template>
  <div class="promotion-container">
    ...
    <div class="platform-section">
        <h3>iOS (아이폰)</h3>
        <p>
            TestFlight 앱을 통해 테스트 버전을 설치할 수 있습니다.<br/>
            아래 버튼을 눌러 TestFlight에 참여하세요.
        </p>
        <button @click="openLink('https://testflight.apple.com/join/cB2uCSdw')">
            iOS 앱 설치 (TestFlight)
        </button>
        <p class="hint">
    ...
    <div class="platform-section">
        ...
        <button @click="openLink('https://korail-xcrew-app-r2.sjang.dev/apk/SJKRLCrew-v1.0.0%2B4.apk')">
            Android 앱 다운로드 (APK)
        </button>
        <p class="hint">
            다운로드 후 파일을 열어 설치를 진행하세요. "출처를 알 수 없는 앱 설치" 권한이 필요할 수 있습니다.
        </p>
    </div>
